...
@EndUserText.label: '[WMS] SO&DO 조회'
define root view entity ZWMS_R_0001_01
  as select from    I_DeliveryDocument           as _DOHeader
    ...
    left outer join ZWMS_R_0002                                  on _DOHeader.DeliveryDocument = lpad( ZWMS_R_0002.DONum, 10, '0' )
{
  ...
  key _DOItem.DeliveryDocumentItem                                                                                                     as DOLine,
      ...
      ZWMS_R_0002.DONum                                                                                                                as R002_DONum,
...
where
  ...
  and  case when ZWMS_R_0002.DONum = '' or  ZWMS_R_0002.DONum is null then 'O' else 'X' end =  'O'
